...
@SuppressWarnings({"DiscouragedInjectionPoint", "OptionalUsedAsFieldOrParameterType", "PointlessArithmeticExpression",})
...
public abstract class MixinItemLayerModel {
	...
	private static void cutelessmod$fewerDots(final int tint, final TextureAtlasSprite sprite, final VertexFormat format, final Optional<TRSRTransformation> transform, final CallbackInfoReturnable<ImmutableList<BakedQuad>> cir,
	                                          final ImmutableList.Builder<BakedQuad> builder, final int width, final int height, final @Coerce Object faceData, final boolean translucent, final int f, final int[] pixels,final boolean ptu, final boolean[] ptv, final int v, final int u, final int alpha, final boolean t) {
